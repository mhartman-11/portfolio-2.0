...
const allProjects = [
  ...
  { category: 'AI Projects', tag: 'AI PROJECT', title: 'March Madness Pool Tracker', desc: 'Live scoreboard for a March Madness player points pool, replacing hours of nightly spreadsheet updates. Built with an NBA Jam arcade feel.', metric: 'Live tracker', url: 'https://march-madness-pool-liard.vercel.app/', img: `${import.meta.env.BASE_URL}screenshots/march-madness.png` },
];
