...
const allProjects = [
  ...
  { category: 'TA Tools', tag: 'FEATURED WORK', title: 'AI in TA Digest (2026)', desc: 'Weekly digest keeping TA professionals current on what is shifting at the intersection of recruiting and AI.', metric: 'Weekly digest', url: 'https://ai-in-ta-digest-mh.netlify.app/', img: `${import.meta.env.BASE_URL}screenshots/ai-digest.png` },
  ...
  { category: 'AI Projects', tag: 'PERSONAL AI PROJECT', title: 'March Madness Pool Tracker', desc: 'Live scoreboard for a March Madness player points pool, replacing hours of nightly spreadsheet updates. Built with an NBA Jam arcade feel.', metric: 'Live tracker', url: 'https://march-madness-pool-liard.vercel.app/', img: `${import.meta.env.BASE_URL}screenshots/march-madness.png` },
];
